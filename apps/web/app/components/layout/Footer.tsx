  ...
  return (
    <footer className="mt-auto py-6">
      <div className="flex items-center justify-center gap-8">
        <a
          href="https://github.com/thepenskefile/degen-dreams"
          target="_blank"
          rel="noopener noreferrer"
          className="group"
        >
          <svg
            className="w-6 h-6 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 transition-colors"
            fill="currentColor"
            viewBox="0 0 24 24"
            aria-hidden="true"
          >
